...
class Trainer:
    def __init__(self, args):
        ...
        self.wavenet = Wavenet(
            args.layer_size, args.stack_size,
            args.in_channels, args.res_channels, lr=args.lr)

        self.data_loader = DataLoader(
            args.data_dir, self.wavenet.receptive_fields,
    ...
    def run(self):
        ...
        for inputs, targets in self.infinite_batch():
            ...
            print(f'[{total_steps}/{self.args.num_steps}] Loss: {loss}')

            if total_steps >= self.args.num_steps:
                break

        self.wavenet.save(self.args.model_dir)
